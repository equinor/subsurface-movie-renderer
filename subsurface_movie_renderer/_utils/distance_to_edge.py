...
def distance_to_edge(S, dx, dy):
    ...
    OUTPUT:	MxN matrix, where each cell contains the shortest distance from the center
    of that particular cell to the center of a cell with value 0. Units are the
    same as for dx and dy.
    """
